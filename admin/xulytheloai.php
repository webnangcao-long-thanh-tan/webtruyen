...
<?php
   if(isset($_POST['themtheloai'])){
    ...
    $tentheloai=$_POST['theloai'];
    $sql_update=mysqli_query($conn,"update theloai set TenTL='$tentheloai' where Id='$id_post_capnhat' ");
    header('location: xulytheloai.php');
   }
   if(isset($_GET['xoa'])){
       $id=$_GET['xoa'];
       $sql_xoa=mysqli_query($conn,"delete from theloai where Id='$id'");
   }
?>
<!DOCTYPE html>
<html>
    ...
    <div class="container">
        <div class="row">
            ...
            if(isset($_GET['quanly'])=='capnhat'){
                $id_capnhat=$_GET['Id'];
                $sql_capnhat=mysqli_query($conn,"select * from theloai where Id='$id_capnhat'");
                ...
                <form action="" method="POST">
                    ...
                    <input type="hidden" class="form-control" name="id_theloai" value="<?php echo $row_capnhat['Id'] ?>">
            ...
            <?php
            $sql_select=mysqli_query($conn,"select * from theloai order by Id desc")
            ?>
            <table class="table table-responsive table-bordered ">
                ...
                <tr>
                    ...
                    <td><a href="?xoa=<?php echo $row_theloai['Id'] ?>">Xóa</a> | <a href="?quanly=capnhat&Id=<?php echo $row_theloai['Id'] ?>">Sửa</a></td>
                </tr>
                <?php
                }
                ?>
