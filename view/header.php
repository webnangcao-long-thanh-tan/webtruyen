...
<body class="container">
		<header class="header">
			...
			<div class="search">
				...
				<button class="bt-search"><i class="fa fa-search icon-search"></i></button>
			</div>
			<div class="icon">
				<a href="#">
				    <svg width="30" height="30" id="icon__open">
				        <path d="M0,5 30,5" stroke="#000" stroke-width="5"/>
				        <path d="M0,14 30,14" stroke="#000" stroke-width="5"/>
				        <path d="M0,23 30,23" stroke="#000" stroke-width="5"/>
				    </svg>
			 	 </a>
				<span id="icon__close">&times;</span>
			</div>
			...
			<nav class="nav">
				<ul id="nav__list">
					...
					<li id="hot"><a href="#">Truyện hot</a>
						<div id="broad-hot" class="broad">
							<ul class="broad_list">
								<li><a href="../comic_hot/index.php">Trong tuần</a></li>
								<li><a href="../comic_hot/index.php">Trong tháng</a></li>
								<li><a href="../comic_hot/index.php">Trong quý</a></li>
								<li><a href="../comic_hot/index.php">Trong năm</a></li>
							</ul>
						</div>
					</li>
...
<!--                                        <li id="account"><a href="">Tại khoản</a>
						<div id="broad-account" class="broad">
							<ul class="	broad_list"	>
								...
								<li><a href="../user_comics/index.php">Truyện yêu thích</a></li>
